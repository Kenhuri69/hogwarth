...
const ITEMS = [
  ...
  // Voies « chance » (Fortune / LCK) & « tempo » (Célérité / AGI) — soutiennent
  // des builds jusqu'ici sans support de loot (0 item Fortune, 1 seul Célérité).
  // Répartis sur des slots distincts ; entrent au pool de coffres via rareté.
  { id:"anneau_trefle",        name:"Anneau du Trèfle",       icon:"🍀", desc:"LCK+1 · Fortune +3 — un trèfle à quatre feuilles serti d'argent", type:"acc", slot:"ring",    formType:"anneau",   rarity:"common",   bonusLck:1, bonusFortune:3, power:2, price:180, tint:"#4caf50" },
  { id:"patte_niffleur",       name:"Patte de Niffleur",      icon:"🐾", desc:"LCK+1 · Fortune +5 — le flair du Niffleur pour ce qui brille",    type:"acc", slot:"trinket", formType:"patte",    rarity:"rare",     bonusLck:1, bonusFortune:5, power:3, price:340, tint:"#b8860b" },
  { id:"medaillon_chance",     name:"Médaillon de Chance",    icon:"🪙", desc:"LCK+2 · Fortune +4 — la fortune sourit à qui le porte",           type:"acc", slot:"amulet",  formType:"medaillon",rarity:"rare",     bonusLck:2, bonusFortune:4, power:3, price:340, tint:"#e0c14a" },
  { id:"bottes_lievre",        name:"Bottes du Lièvre",       icon:"👟", desc:"AGI+1 · Célérité +3 — vives comme un lièvre de garenne",          type:"acc", slot:"feet",    formType:"bottes",   rarity:"common",   bonusAgi:1, bonusCelerite:3, power:2, price:180, tint:"#9c8a5a" },
  { id:"bracelet_tempo",       name:"Bracelet du Tempo",      icon:"⏱️", desc:"AGI+2 · Célérité +4 — le pouls du duel bat à ton poignet",       type:"acc", slot:"hands",   formType:"bracelet", rarity:"rare",     bonusAgi:2, bonusCelerite:4, power:3, price:340, tint:"#7fd6e0" },
