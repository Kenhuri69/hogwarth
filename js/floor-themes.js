...
const FLOOR_THEMES = {
  ...
  depths:   { range: [7, null], wall: 'cavern_wall', floor: 'cavern_floor', ceiling: 'cavern_ceiling', ambient: 'depths',  label: "Profondeurs Oubliées" },
  // V2 préparé (palier 14+, assets rune_* déjà présents) :
