...
const ITEM_ICON_SVG_REGISTRY = {
  ...
  // ── Récompenses des Quêtes Signature de Maison (fallback vectoriel) ──
  // Bannière de Godric (Gryffondor) : étendard rouge à étoile d'or, hampe dorée.
  banniere_godric: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="6" width="3.6" height="52" rx="1.6" fill="#c9a23c"/><circle cx="15.8" cy="6" r="3" fill="#e8c862"/><path d="M19 10 L52 10 L52 45 L42 38 L35.5 45 L29 38 L19 45 Z" fill="#7a0f12"/><path d="M19 10 L52 10 L52 14.5 L19 14.5 Z" fill="#d3a625"/><path d="M33 19 L36 26 L43 26 L37.5 30.5 L39.5 38 L33 33.5 L26.5 38 L28.5 30.5 L23 26 L30 26 Z" fill="#f0d782"/></svg>`,
  // Langue-de-plomb (Serpentard) : médaillon vert serti d'argent sur chaîne.
  langue_de_plomb: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M18 12 Q32 26 46 12" fill="none" stroke="#9aa0a6" stroke-width="2.4"/><circle cx="32" cy="40" r="14" fill="#1a472a"/><circle cx="32" cy="40" r="14" fill="none" stroke="#aaaaaa" stroke-width="2.2"/><ellipse cx="32" cy="38" rx="6" ry="8.5" fill="#3aa86a"/><ellipse cx="30" cy="35" rx="2" ry="3" fill="#cfeede"/><rect x="29" y="22" width="6" height="6" rx="2" fill="#9aa0a6"/></svg>`,
  // Codex de Rowena (Serdaigle) : grimoire bleu nuit, fermoir bronze, étoile.
  codex_rowena: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M14 12 L48 12 Q52 12 52 16 L52 52 L18 52 Q14 52 14 48 Z" fill="#0e1a40"/><path d="M14 12 L48 12 Q52 12 52 16 L52 20 L14 20 Z" fill="#1a2a5a"/><path d="M33 26 L36 33 L43 33 L37.5 37.5 L39.5 45 L33 40.5 L26.5 45 L28.5 37.5 L23 33 L30 33 Z" fill="#946d2d"/><rect x="49" y="28" width="5" height="12" rx="2" fill="#946d2d"/></svg>`,
  // Cœur du Refuge (Poufsouffle) : médaille dorée à ruban, cœur central.
  coeur_refuge: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M24 8 L40 8 L36 24 L28 24 Z" fill="#7a1f1f"/><circle cx="32" cy="38" r="17" fill="#f0c75e"/><circle cx="32" cy="38" r="17" fill="none" stroke="#caa23c" stroke-width="2.4"/><circle cx="32" cy="38" r="11" fill="#372e29"/><path d="M32 45 Q24 39 26 34 Q28.5 31 32 35 Q35.5 31 38 34 Q40 39 32 45 Z" fill="#f0c75e"/></svg>`,
};
