...
const ITEM_ICON_SVG_REGISTRY = {
  // Items Ruines/Boucle (ch.11 P1) — SVG inline (pas de PNG painterly requis).
  cristal_givre: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M32 5 L47 26 L32 59 L17 26 Z" fill="#8fd6f0"/><path d="M32 5 L47 26 L32 30 Z" fill="#c4ecff"/><path d="M32 5 L17 26 L32 30 Z" fill="#6fc0e2"/><path d="M32 30 L47 26 L32 59 Z" fill="#5aa9d4"/><path d="M32 30 L17 26 L32 59 Z" fill="#7cc6e8"/><path d="M32 11 L41 26 L32 26 Z" fill="#eaf8ff" opacity="0.85"/></svg>`,
  essence_chaleur: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M28 12 L36 12 L36 25 L44 45 Q45.5 53 37 53 L27 53 Q18.5 53 20 45 L28 25 Z" fill="#ffb347"/><path d="M21 40 Q32 36 43 40 L44 45 Q45.5 53 37 53 L27 53 Q18.5 53 20 45 Z" fill="#ff7a1a"/><rect x="26" y="7" width="12" height="6" rx="2" fill="#caa85a"/><path d="M32 29 Q27 36 32 43 Q37 36 32 29 Z" fill="#fff0c0"/></svg>`,
  ...
  // Philtre du Mage (Potions 2.0 — Lot P8) : mana évolutif, indigo arcanique.
  philtre_mage: _potionSvg('cl_phmage', 30, '#5a4ad0', '#b0a0f0', '#3d6cc0'),
  // Résilience Maison + 4 Premium (Potions 2.0 — Lot P9). Premium = liquide
  // teinté Maison + étincelles (cran d'affichage de prestige).
  potion_resilience_maison: _potionSvg('cl_resm', 33, '#caa84c', '#f0d782', '#5a4020'),
  elixir_lion_ardent: _potionSvg('cl_lion', 27, '#a01818', '#e85a4a', '#d3a625', true),
