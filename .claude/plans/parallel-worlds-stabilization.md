...
- [ ] S3.10 `tests/parallel-live-checklist.md` — **rédigé** (protocole A→H + chemins d'erreur) ; **exécution manuelle 2 clients NON FAITE** (S1.3 désormais débloqué — peut être joué)
