...
| P3.3 | Refactor `monsters.js`/`data.js`/`npcs.js` en sous-fichiers | 📋 **plan prêt (2026-06-21)** | Plan de découpage détaillé (schéma, relations, ordre de chargement, matrice d'impact, risques) : [`p33-data-split.md`](./p33-data-split.md). Reco : faire `data.js` (Lot A, multi-concern) ; différer monsters/npcs (mono-concern, coût skills). Non implémenté — décision en attente. |
