...
**Statut :** ✅ clos — livré & mergé (PR #745, 2026-07-29) ; archivé le 2026-08-24.
...
5. [x] Suite smoke **complète** → **vérifier** : 285/285, aucun écart.
6. [x] Doc : `CLAUDE.md` (helpers) + revue §2 A3/A4 marquée traitée.
7. [x] Cache-bump (JS servis modifiés) + `check_cache_versions.js`.
8. [x] Commit → push → PR draft (nouvelle PR : #744 mergée, §6).
