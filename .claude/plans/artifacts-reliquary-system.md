...
| **P3 (partie 3)** ⏳ | **PNJ + drops Premium + Chœur** | PNJ Apothicaire des Reliques (**nécessite un portrait** — pipeline Copilot Règle B) ; obtention Premium en Ruines (coffres ≥14) / drops boss Ténébreux ; Codex **Chœur des Fondateurs** (dépend des **reliques vocales §1.4 C, non implémentées** → lot reliques vocales requis d'abord) | à faire |
