...
| **P3 (partie 3b)** ⏳ | **Reliques vocales + Chœur** | 4 items `relique_vocale` §1.4 C (icônes Copilot **déjà extraites & banques** dans `tools/raster_src/voix_*`) + Codex **Chœur des Fondateurs** (`allItems` des 4) + titre profil. **Bloqué sur décision d'obtention** : §1.4 C dit « non vendable, écho-gaté Boucle » → hook à arbitrer | à arbitrer |
