...
const CACHE_VERSION = 'hogwarth-v27';
...
const PRECACHE_URLS = [
  ...
  './js/item-icons.js?v=10',
  './js/state.js?v=14',
  './js/ui.js?v=7',
  './js/ui-character-sheet.js?v=2',
  ...
  './js/renderer-sprites.js?v=1',
  './js/renderer-entities.js?v=1',
  './js/renderer-minimap.js?v=6',
  './js/movement.js?v=20',
  './js/movement-floors.js?v=1',
  './js/movement-interactions.js?v=1',
  './js/swipe-canvas.js?v=4',
  './js/battle.js?v=12',
  './js/battle-rewards.js?v=1',
  './js/battle-death.js?v=1',
  './js/teleport.js?v=1',
  './js/battle-spells.js?v=5',
  './js/battle-ui.js?v=1',
  './js/inventory-core.js?v=3',
  './js/inventory.js?v=10',
  './js/inventory-spells.js?v=1',
  './js/potions.js?v=2',
  './js/quests-templates.js?v=1',
  './js/quests.js?v=7',
