...
const CACHE_VERSION = 'hogwarth-v193';
...
const PRECACHE_URLS = [
  ...
  './js/ux-improvements.js?v=7',
  './js/combat-fx.js?v=11',
  './js/haptics.js?v=2',
  './js/audio.js?v=2',
  './js/audio-music.js?v=7',
  './js/audio-sfx.js?v=17',
  './js/icons.js?v=1',
  ...
  './js/teleport.js?v=2',
  './js/battle-spells.js?v=22',
  './js/battle-ui.js?v=10',
  './js/inventory-core.js?v=9',
  './js/inventory.js?v=23',
  './js/inventory-spells.js?v=11',
  './js/potions.js?v=7',
  './js/quests-templates.js?v=18',
  './js/quests.js?v=19',
