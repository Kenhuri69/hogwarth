...
const CACHE_VERSION = 'hogwarth-v127';
...
const PRECACHE_URLS = [
  ...
  './js/renderer-entities.js?v=6',
  './js/renderer-minimap.js?v=8',
  './js/movement.js?v=35',
  './js/movement-floors.js?v=15',
  './js/movement-interactions.js?v=16',
