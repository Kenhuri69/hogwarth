...
const CACHE_VERSION = 'hogwarth-v1';
...
const PRECACHE_URLS = [
  ...
  './js/textures.js?v=1',
  './js/renderer.js?v=8',
  './js/renderer-effects.js?v=8',
  './js/renderer-minimap.js?v=4',
  './js/movement.js?v=13',
  './js/swipe-canvas.js?v=4',
  './js/battle.js?v=6',
  './js/teleport.js?v=1',
  './js/battle-spells.js?v=2',
  './js/battle-ui.js?v=1',
  './js/inventory.js?v=5',
  './js/potions.js?v=1',
  './js/quests.js?v=6',
  './js/npc-dialog.js?v=7',
  './js/karaoke.js?v=1',
  './js/intro.js?v=2',
  './js/shop.js?v=5',
  './js/save.js?v=9',
  ...
  './img/icons/pwa/icon-192.png',
  './img/icons/pwa/icon-512.png',
