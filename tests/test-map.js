...
const TEST_MAP = {
  ...
  'js/battle.js':        ['status', 'weaken', 'duostatus', 'combat', 'crit', 'stun',
                          ...
                          'solosoftlock'],
  'js/battle-rewards.js':['combat', 'darkrewards', 'ironman', 'victory',
                          'houserewardflow', 'farming'],
  'js/battle-death.js':  ['ironman', 'solosoftlock', 'visit', 'combat'],
  ...
  'js/movement-floors.js':       ['respawn', 'floortheming', 'floorevent', 'stairsgated',
                                  'victory', 'darkvariant', 'starthub'],
  'js/movement-interactions.js': ['fountain', 'search', 'trap', 'altar', 'rune',
                                  'riddlestele', 'sealedroom', 'secretpass', 'grimoire'],
